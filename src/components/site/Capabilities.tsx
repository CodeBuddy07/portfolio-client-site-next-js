...
export const capabilities = [
  {
    ...
    body: "Multi-tenant products with real permission models, billing, reporting and the operational back office nobody sees. NestJS and PostgreSQL behind Next.js.",
